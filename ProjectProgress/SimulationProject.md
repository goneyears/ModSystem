...
# SimulationProject StreamingAssets配置和示例模组
...
```json
{
  "routes": [
    {
      "name": "button_to_robot_interaction",
      "sourceEvent": "ButtonMod.ButtonClickedEvent",
      "conditions": [
        {
          "property": "ButtonId",
          "operator": "startswith",
      ...
      "actions": [
        {
          "eventType": "RobotMod.RobotCommandEvent",
          "targetMod": "robot_mod",
          "parameters": {
            "command": "move_to_button",
            "targetId": "${ButtonId}",
            "speed": 2.0
          },
          "delay": 100
    ...
    {
      "name": "robot_status_update",
      "sourceEvent": "RobotMod.RobotStateChangedEvent",
      "conditions": [
        {
          "property": "State",
          "operator": "==",
      ...
      "actions": [
        {
          "eventType": "ModSystem.Unity.UIUpdateEvent",
          "parameters": {
            "uiElement": "robot_status_display",
            "text": "Robot is moving to ${TargetPosition}",
            "color": [0, 1, 0, 1]
          }
        }
      ],
    ...
    },
    {
      ...
      "sourceEvent": "ModSystem.Core.EmergencyStopEvent",
      "conditions": [],
      "actions": [
        {
          "eventType": "RobotMod.RobotStopEvent",
          "parameters": {
            "immediate": true,
            "reason": "${Reason}"
          }
        ...
        {
          "eventType": "ButtonMod.DisableAllButtonsEvent",
          "parameters": {
  ...
  "workflows": [
    {
      "name": "robot_patrol_workflow",
      "trigger": {
        "event": "ButtonMod.ButtonClickedEvent",
        "conditions": [
          {
            "property": "ButtonId",
            "operator": "==",
            "value": "start_patrol_button"
          }
        ]
      },
      "steps": [
        {
          ...
          "event": "RobotMod.RobotCommandEvent",
          "parameters": {
        ...
        },
        {
          ...
          "event": "RobotMod.PatrolCompletedEvent",
          "timeout": 60000
        },
        {
          "action": "publish_event",
          "event": "ButtonMod.UpdateButtonStateEvent",
          "parameters": {
            "buttonId": "start_patrol_button",
            "state": "ready",
            "text": "Start Patrol"
          }
        }
...
### ModConfigs/security_config.json
```json
{
  "requireSignedMods": false,
  "publicKeyPath": "StreamingAssets/ModConfigs/keys/public.key",
  "modDirectory": "Mods",
  "allowedModPaths": [
    "Assets/StreamingAssets/Mods",
    "Assets/StreamingAssets/ModPackages"
...
```json
{
  "modSystem": {
    ...
    "maxConcurrentMods": 50
  },
  "paths": {
    "modsDirectory": "Mods",
    "packagesDirectory": "ModPackages",
    "cacheDirectory": "{persistent}/ModCache",
    "logsDirectory": "{persistent}/ModLogs",
    "tempDirectory": "{temp}/ModTemp"
  },
  "loading": {
    "loadOrder": [
      "core_services",
  ...
  "networking": {
    "enabled": false,
    "allowRemoteMods": false,
    "modRepositoryUrl": "https://mods.example.com/api/v1",
    "updateCheckInterval": 86400,
    "downloadTimeout": 60000
  },
  "compatibility": {
    "minUnityVersion": "2021.3.0",
    "maxUnityVersion": "2023.2.999",
...
### ModConfigs/routes/button_routes.json
```json
{
  "routes": [
    {
      "name": "button_hover_effect",
      "sourceEvent": "ModSystem.Unity.PointerEnterEvent",
      "conditions": [
        {
          "property": "TargetTag",
          "operator": "==",
      ...
      "actions": [
        {
          "eventType": "ButtonMod.ButtonHoverEvent",
          "parameters": {
            "buttonId": "${TargetName}",
            "hoverState": true
          }
    ...
    },
    {
      ...
      "actions": [
        {
          "eventType": "ModSystem.Unity.PlaySoundEvent",
          "parameters": {
...
### Mods/ButtonMod/manifest.json
```json
{
  "id": "button_mod",
  "name": "Interactive Button Mod",
  "version": "1.0.0",
  "author": "ModSystem Team",
  "description": "Adds interactive buttons with customizable actions",
  "unity_version": "2021.3",
  "sdk_version": "1.0.0",
  "main_class": "ButtonMod.ButtonModBehaviour",
  "behaviours": [
    "ButtonMod.ButtonInteractionHandler",
    "ButtonMod.ButtonEffectsController"
  ],
  "dependencies": [],
  "services": [
    {
      "interface": "ButtonMod.IButtonService",
      "implementation": "ButtonMod.ButtonService"
    }
  ],
  "permissions": [
    "event_publish",
  ...
  "resources": {
    "models": [],
    "objects": ["green_button.json", "red_button.json", "control_panel.json"],
    "configs": ["button_config.json", "button_styles.json"],
    "textures": ["button_normal.png", "button_pressed.png"],
    "audio": ["button_click.wav", "button_hover.wav"]
  },
  "metadata": {
    "tags": ["ui", "interaction", "button"],
    "category": "Interface",
    "homepage": "https://example.com/mods/button-mod"
  }
}
```

### Mods/ButtonMod/Config/button_config.json
```json
{
  "defaultButtonStyle": {
    "size": [1.0, 0.2, 1.0],
    "normalColor": [0.2, 0.8, 0.2, 1.0],
    "hoverColor": [0.3, 0.9, 0.3, 1.0],
    "pressedColor": [0.1, 0.6, 0.1, 1.0],
  ...
  "effects": {
    ...
    "particleEffects": {
      "onClick": "button_click_particles",
      "onHover": "button_hover_glow"
    }
  },
  "layout": {
    "defaultSpacing": 0.2,
...
### Mods/ButtonMod/Objects/green_button.json
```json
{
  "objectId": "button_green",
  ...
  "components": [
    ...
    },
    {
      ...
      "properties": {
        ...
        "config": {
          "buttonId": "green_action_button",
          "buttonType": "action",
          "actionEvent": "ButtonMod.GreenButtonAction",
          "soundOnClick": "button_click.wav",
          "glowOnHover": true,
          "allowDisable": true
        }
      }
...
### Mods/ButtonMod/Source/ButtonModBehaviour.cs (示例代码片段)
```csharp
using System;
using System.Collections.Generic;
using ModSystem.Core;
...
namespace ButtonMod
{
    ...
    {
        public string BehaviourId => "button_mod_main";
        public string Version => "1.0.0";
        
        private IModContext context;
        private Dictionary<string, ButtonInstance> buttons;
        private ButtonConfig config;
        
        public void OnInitialize(IModContext context)
        {
            this.context = context;
            this.buttons = new Dictionary<string, ButtonInstance>();
            
            // 加载配置
            LoadConfiguration();
            
            // 注册服务
            RegisterButtonService();
            
            // 订阅事件
            context.EventBus.Subscribe<SystemReadyEvent>(OnSystemReady);
            context.EventBus.Subscribe<CreateButtonRequest>(OnCreateButtonRequest);
            
            context.Log("ButtonMod initialized successfully!");
        }
        ...
        private void RegisterButtonService()
        {
            var service = new ButtonService(this);
            context.Services.RegisterService<IButtonService>(service);
        }
    }
}
```

### Mods/RobotMod/manifest.json
```json
{
  "id": "robot_mod",
  "name": "AI Robot Controller",
  "version": "1.0.0",
  "author": "ModSystem Team",
  "description": "Adds intelligent robots with pathfinding and interaction capabilities",
  "unity_version": "2021.3",
  "sdk_version": "1.0.0",
  "main_class": "RobotMod.RobotModBehaviour",
  "behaviours": [
    "RobotMod.RobotAIController",
    "RobotMod.RobotMovementController",
    "RobotMod.RobotSensorSystem"
  ],
  "dependencies": [
    {
      "id": "button_mod",
  ...
  "services": [
    ...
    {
      "interface": "RobotMod.IPathfindingService",
      "implementation": "RobotMod.PathfindingService"
    }
  ],
  "permissions": [
    "event_publish",
  ...
  "resources": {
    "models": ["robot_base.gltf", "robot_arm.gltf"],
    "objects": ["robot_unit.json", "charging_station.json"],
    "configs": ["robot_config.json", "ai_config.json"],
    "textures": ["robot_diffuse.png", "robot_normal.png", "robot_metallic.png"],
    "audio": ["robot_move.wav", "robot_beep.wav", "robot_error.wav"]
  },
  "metadata": {
    "tags": ["ai", "robot", "automation", "pathfinding"],
    "category": "AI/Automation",
    "homepage": "https://example.com/mods/robot-mod"
  }
}
```

### Mods/RobotMod/Config/robot_config.json
```json
{
  "robotDefaults": {
    "moveSpeed": 2.0,
  ...
  "behaviors": {
    "idle": {
      "priority": 0,
      "energyCost": 0.01,
      "animations": ["robot_idle_01", "robot_idle_02"]
    },
    "patrol": {
      "priority": 1,
      "energyCost": 0.1,
  ...
  "communication": {
    ...
    "maxCommunicationRange": 20.0,
    "teamChannels": ["alpha", "beta", "gamma"]
  }
}
```

### Mods/RobotMod/Objects/robot_unit.json
```json
{
  "objectId": "robot_unit_mk1",
  "name": "Robot Unit MK1",
  "components": [
    {
      "type": "Transform",
    ...
    },
    {
      "type": "MeshFilter",
      "properties": {
        "meshPath": "Models/robot_base.gltf"
      }
    },
    {
      "type": "MeshRenderer",
      "properties": {
        "materials": [
          {
            "shader": "Standard",
            "mainTexture": "Textures/robot_diffuse.png",
            "normalMap": "Textures/robot_normal.png",
            "metallicMap": "Textures/robot_metallic.png",
            "metallic": 0.8,
            "smoothness": 0.7
          }
        ]
    ...
    },
    {
      "type": "ObjectBehaviour",
      "properties": {
        "behaviourClass": "RobotMod.RobotBehaviour",
        "config": {
          "robotId": "robot_001",
          "robotType": "worker",
          "startBehavior": "idle",
          "teamChannel": "alpha",
          "sensors": ["vision", "proximity", "battery"],
          "capabilities": ["move", "carry", "interact"]
        }
      }
    }
  ]
...
### ModPackages/README.txt
```
ModPackages Directory
====================

This directory contains pre-packaged mods (.modpack files) that can be loaded by the ModSystem.

File Format:
-----------
.modpack files are ZIP archives containing:
- manifest.json (required)
- Assemblies/ (compiled mod DLLs)
- Objects/ (object definitions)
- Config/ (configuration files)
- Resources/ (textures, models, audio)
- signature.sig (optional, for signed mods)

Installing Mods:
---------------
1. Place .modpack files in this directory
2. The ModSystem will automatically detect and load them on startup
3. Check the console for any loading errors

Creating Mod Packages:
---------------------
Use ModBuilder tool:
  ModBuilder package --project path/to/mod

Or manually:
1. Build your mod in Release mode
2. Create a ZIP file with the required structure
3. Rename .zip to .modpack

Security:
---------
- Only install mods from trusted sources
- Check mod permissions in manifest.json
- Enable mod signing in security_config.json for production
```

### ModPackages/sample_mods_v1.0.0.modpack
```
[This would be a binary .modpack file - ZIP archive containing sample mods]

Contents:
- ButtonMod/
  - manifest.json
  - Assemblies/button_mod.dll
  - Objects/*.json
  - Config/*.json
  - Resources/Audio/*.wav
...
- RobotMod/
  - manifest.json
  - Assemblies/robot_mod.dll
  - Objects/*.json
  - Config/*.json
  - Resources/Models/*.gltf
  - Resources/Audio/*.wav
```

## 4. Unity ProjectSettings配置

### ProjectSettings/TagManager.asset (部分内容)
```yaml
%YAML 1.1
...
### ProjectSettings/InputManager.asset (部分内容)
```yaml
%YAML 1.1
%TAG !u! tag:unity3d.com,2011:
--- !u!13 &1
InputManager:
  ...
  m_Axes:
  - serializedVersion: 3
    m_Name: ModDebugToggle
    descriptiveName: Toggle Mod Debug UI
    ...
    joyNum: 0
  - serializedVersion: 3
    m_Name: ModEmergencyStop
    descriptiveName: Emergency Stop All Mods
    descriptiveNegativeName: 
    negativeButton: 
...
### ModConfigs/routes/robot_routes.json
```json
{
  "routes": [
    {
      "name": "robot_low_battery",
      "sourceEvent": "RobotMod.BatteryLevelEvent",
      "conditions": [
        {
          "property": "Level",
          "operator": "<",
      ...
      "actions": [
        {
          "eventType": "RobotMod.NavigateToChargingStationEvent",
          "parameters": {
            "priority": "high",
        ...
        {
          "eventType": "ModSystem.Unity.ShowNotificationEvent",
          "parameters": {
            "message": "Robot ${RobotId} battery low - returning to charging station",
            "type": "warning",
            "duration": 3000
          }
        }
    ...
    {
      "name": "robot_collision_avoidance",
      "sourceEvent": "RobotMod.ProximitySensorEvent",
      "conditions": [
        {
          "property": "Distance",
          "operator": "<",
      ...
      "actions": [
        {
          "eventType": "RobotMod.AvoidanceManeuverEvent",
          "parameters": {
...
这些配置文件和示例模组提供了完整的ModSystem运行环境，包括：

1. **通信配置** - 定义了模组间的事件路由和工作流
2. **安全配置** - 设置了权限、资源限制和API黑名单
3. **系统配置** - 控制ModSystem的行为和性能
4. **示例模组** - ButtonMod和RobotMod展示了实际的模组结构
5. **项目设置** - Unity项目的标签和输入配置

这样完整的配置使得ModSystem可以立即运行并展示其功能。